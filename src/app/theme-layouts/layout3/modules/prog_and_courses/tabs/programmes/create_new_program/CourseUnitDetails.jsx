...
function CourseUnitDetails() {
  ...
  const [mode, setMode] = useState("unit_details");
  ...
  const onFinish = async (values) => {
    ...
    const payload = {
      courseUnit: {
        ...
        id: selectedUnit?.selectedRow.id,
      },
  ...
  useSelector(() => {
    if (selectedUnit) {
      form.setFieldsValue({
        course_unit_code: selectedUnit?.selectedRow.course_unit_code,
        course_unit_title: selectedUnit?.selectedRow.course_unit_title,
        course_unit_year: selectedUnit?.selectedRow.course_unit_year,
        course_unit_level: selectedUnit?.selectedRow.course_unit_level,
        credit_units: selectedUnit?.selectedRow.credit_units,
        course_unit_sem: selectedUnit?.selectedRow.course_unit_sem,
        grading_id: selectedUnit?.selectedRow.grading_id,
      });
    }
  }, [selectedUnit]);
    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <Radio.Button value="unit_details">
              Course Unit Details
            </Radio.Button>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <Space>
                      <Button onClick={() => dispatch(setEditModule(false))}>
                        Cancel
                      </Button>
          ...
          {mode == "logs" && (
            ...
            >
              ...
              >
                ...
                <span>
                  {selectedUnit?.selectedRow.added_user
                    ? `${selectedUnit?.selectedRow.added_user.title} ${selectedUnit?.selectedRow.added_user.staff_name}`
                    : null}
                </span>
              </div>
              <div
              ...
              >
                ...
                <span>
                  {selectedUnit?.selectedRow.added_on
                    ? `${formatDateString(parseInt(selectedUnit?.selectedRow.added_on))}`
                    : null}
                </span>
              </div>
              ...
              >
                ...
                <span>
                  {selectedUnit?.selectedRow.last_modified_user
                    ? `${selectedUnit?.selectedRow.last_modified_user.title} ${selectedUnit?.selectedRow.last_modified_user.staff_name}`
                    : null}
                </span>
              </div>
              ...
              >
                ...
                <span>
                  {selectedUnit?.selectedRow.last_modified_on
                    ? `${formatDateString(parseInt(selectedUnit?.selectedRow.last_modified_on))}`
                    : null}
                </span>
              </div>
            </div>
...
export default CourseUnitDetails;
