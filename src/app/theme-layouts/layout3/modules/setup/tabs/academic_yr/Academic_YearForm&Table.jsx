...
function TaskDistributionWidget() {
  ...
  const [orderBy, setOrderBy] = useState("academic");
  ...
  const handleEdit = (rowData) => {
    setValue("AcademicName", rowData.academic);
  };
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    className="uppercase"
                    margin="normal"
                    helperText="Add Academic year and click Save"
                  />
                )}
              />
              ...
              <TableHead>
                <TableRow>
                  ...
                  <TableCell
                    ...
                    align="left"
                    padding={"normal"}
                    sortDirection={orderBy === "academic" ? order : false}
                  >
                    <TableSortLabel
                      active={orderBy === "academic"}
                      direction={orderBy === "academic" ? order : "asc"}
                      onClick={(event) => handleRequestSort(event, "academic")}
