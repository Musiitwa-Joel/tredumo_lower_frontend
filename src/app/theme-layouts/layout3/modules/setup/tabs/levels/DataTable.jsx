...
function DataTable() {
  ...
  if (error) {
    dispatch(
      showMessage({
        message: "Failed to load levels " + error.message,
        variant: "error",
      })
    );
  }
  ...
  const visibleRows = React.useMemo(
    () =>
      stableSort(levels, getComparator(order, orderBy)).slice(
        page * rowsPerPage,
        page * rowsPerPage + rowsPerPage
      ),
    [order, orderBy, page, rowsPerPage, levels]
  );
                        ...
                        <Tooltip title="Edit">
                          <Edit
                            onClick={() => {
                              ...
                              dispatch(updateSelectedLevel(row));
                            }}
                            style={{
                              color: "blue",
                              fontSize: 18,
