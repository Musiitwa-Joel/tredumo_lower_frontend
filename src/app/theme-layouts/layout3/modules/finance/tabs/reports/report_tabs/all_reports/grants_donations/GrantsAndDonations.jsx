...
import GrantsAndDonationsTable from "./GrantsAndDonationsTable";
import ReceivablesVisualisation from "./GrantsAndDonationsVisualisation";
...
function GrantsAndDonations() {
  ...
  return (
    <div>
      ...
      >
        DATA VISUALISATION FOR GRANTS AND DONATIONS
      </Divider>
      <>
