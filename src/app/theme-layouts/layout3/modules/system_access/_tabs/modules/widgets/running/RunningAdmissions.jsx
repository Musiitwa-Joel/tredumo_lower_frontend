...
const rows = [
  ...
  {
    module_name: "Results Manager",
    active: "Yes",
    status: "Active",
  },
  {
    module_name: "Photos Manager",
    active: "No",
    status: "Active",
  },
  {
    module_name: "Student's Information Center",
    active: "Yes",
    status: "Active",
  },
  {
...
const columns = [
  { id: "module_name", label: "Module Name", maxHeight: 0 },
  {
    id: "active",
    numeric: false,
    label: "Active",
                ...
                <TableBody>
                  {visibleRows.map((row, index) => {
                    ...
                    const getStatusColor = (status) => {
                      if (status === "Active") {
                        return "bg-green-50 text-green-800 dark:bg-green-600 dark:text-green-50";
